...
public sealed class Handle
{
    ...
    private static Expression<Func<DCreateCommand<IRecordArgumentExistenceCommand<TParameter>, IRecordArgumentExistenceCommandFactory>, bool>> MatchCommandCreationDelegate<TParameter>(
